...
export default function Project(){
    return (
        <section className="my-32">
            <h1 className="text-center text-6xl font-bold m-20">Featured <span className="text-[#673DE5]">Projects</span></h1>
            <div className=" p-6 grid grid-cols-6 gap-10">
                <div className="col-span-2 bg-[#111122] rounded-3xl">
                    <Image src={Project1} alt="" className="rounded-t-3xl"/>
                    <div className="p-8">
                        <h1 className="text-4xl">Convers</h1>
